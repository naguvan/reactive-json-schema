...
import { flow, IModelType, Snapshot, types } from "mobx-state-tree";
...
export interface IValueConfig<V, T, C, M extends IMeta<C>>
...
export function createValue<V, T, C, M extends IMeta<C>>(
  type: T,
  kind: ISimpleType<V>,
  defaultv: V,
